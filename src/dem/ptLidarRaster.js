...
/**
 * How fine the rasters are, against how fine the sheet can be drawn.
 *
 * The point of this data is close-ups, and it is worth being able to say when it
 * is not buying anything: past about a third of a millimetre per sample the pen
 * is the limit, not the terrain, and the ordinary tiled elevation will look the
 * same for a fraction of the trouble.
 *
